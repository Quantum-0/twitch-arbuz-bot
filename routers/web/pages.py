        ...
        "roadmap.html",
        {
            "roadmap": [
                ...
                },
                {
                    ...
                    "Добавил лайки для стримеров :з Модерация референсов. Множество прочих мелких доработок",
                },
            ],
            "todos": [
                ...
                "Таблица статистики сообщений за 10 минут (тип/подтип), агрегатор в оперативке с батч-дампом в БД,"
                " API для отдачи графиков по 10мин/часу/дню",
                "Система обновления токенов Twitch пользователей по аналогии с memealerts oauth",
                "Глобальная обработка InvalidRefreshTokenException / UnauthorizedException — автоматический логаут",
                "Уведомление при смене пароля (награды и рейд отключены)",
            ],
            "request": request,
            "user": user,
        },
